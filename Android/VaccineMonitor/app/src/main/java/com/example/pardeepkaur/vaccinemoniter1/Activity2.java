    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            //    Toast.makeText(getApplicationContext(), pname, Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(getApplicationContext(),"Turn on Bluetooth for Connection",Toast.LENGTH_SHORT)
                        .show();                Intent enableBtIntent = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
